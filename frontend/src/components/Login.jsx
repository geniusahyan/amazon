  ...
  return (
    <div className='flex flex-col gap-3 justify-center items-center' >
        ...
        <form className='flex-col border gap-3 p-2 w-[20rem] rounded flex' action="">
            ...
            <button className="h-8 px-3 text-white w-full ml-auto mr-auto rounded bg-yellow-500 ">Login</button>
        ...
        <div className="flex flex-col w-80">
            <div className="divider divider-accent">New to amazon ?</div>
        </div>
        <button className="h-8 px-3 text-white w-full ml-auto mr-auto rounded max-w-[14rem] bg-yellow-500 ">Continue</button>
